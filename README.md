...
Clone repository to: `$GOPATH/src/github.com/pkliczewski/terraform-provider-kubevirt`

```sh
$ mkdir -p $GOPATH/src/github.com/pkliczewski; cd $GOPATH/src/github.com/pkliczewski
$ git clone git@github.com:pkliczewski/terraform-provider-kubevirt
```

Enter the provider directory and build the provider

```sh
$ cd $GOPATH/src/github.com/pkliczewski/terraform-provider-kubevirt
$ make build
```
